...
const QUESTIONS = [
    ...
    new Quiz("「最初はグー」初めて使った人は。", ["ヒカキン", "吉澤俊介", "じゃんけん協会会長 松本さん", "志村けん"], 4, 1, 1),
    ...
    new Quiz("40人クラスに、誕生日が同じ組み合わせがいる確率でもっとも近いものは？", ["約12%", "約27%", "約90%", "約3%"], 3, 2, 2),
    new Quiz("ダンゴ虫の呼吸法は？何呼吸？", ["肺呼吸", "水の呼吸", "えら呼吸", "皮膚呼吸"], 3, 3, 3),
    ...
    new Quiz("海上で事件や事故が起こった時、海上保安庁に通報する番号はどれでしょうか？", ["104", "118", "177", "189"], 2, 2, 2),
